...
API_ID = int(environ['21562110'])
API_HASH = environ['4d1e1f333214a39cea79a3196cbed290']
BOT_TOKEN = environ['7387135619:AAEG0w5cWndk0oKjoRShArEy5rK0OYCyUP8']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6909056240').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://guday3417:GUDAY333@cluster0.pdrwfcn.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "guday3417")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'hdrflix_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL','-1002191088551'))

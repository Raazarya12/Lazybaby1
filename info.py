...
BOT_TOKEN = environ['7086961899:AAEHKfsJhiBc98EsPha8jdXOb-awOx-9Omc']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7131600952').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', -1002184591380.').split()]

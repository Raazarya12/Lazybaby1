...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'dev')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Movies™](https://t.me/)</b>⚡\n\<b>🎬 {file_name}</b>/n/n/n<b>📀 Size: {file_size}</b>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [Movies™](https://t.me/)</b> ↭  🔥")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b>\n\n<b>🎬 {title} ({year})</b> \n\n<b>🎭 Genres:</b> {genres} \n\n<b>✨ IMDb Rating:</b> {rating}/10\n\n <b>⏳ Runtime:</b> {runtime} \n\n<b>📆 Release Info:</b> {release_date}/n/n♥️ we are nothing without you ♥️ \n\n💛 Please Share Us 💛\n\n⚠️Click on the button 👇 below to get your query privately")
...
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','real_Movies') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','dev') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','dev')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "dev") #[ without @ ]
